...
def publish_image(image_file, image_name, image_format, container_format, properties_dict):
    ...
    with open(image_file, 'r') as fimage:
        glance.images.create(name=image_name, is_public=True, disk_format=image_format, container_format=container_format,
                             file=fimage, properties=properties_dict, __debug__)
